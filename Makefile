...
.PHONY: klayout_extract_and_drc
klayout_extract_and_drc: extract_gds
ifndef component
...
ifndef component
	...
	cd ./xschem; xschem -n -s -q --no_x --tcl 'set top_subckt 1' ./src/$(component).sch -o ./src/
...
ifndef component
	...
	export NETGEN_COLUMNS=80; netgen -batch lvs "./xschem/src/$(component).spice $(component)" "./mag/$(component).spice $(component)" ./netgen/sky130A_setup.tcl ./netgen/$(component)_comp.out -blackbox
